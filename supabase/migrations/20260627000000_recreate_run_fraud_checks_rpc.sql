-- Deterministic rebuild of fraud RPC to prevent intermittent PGRST202
-- during Paystack init/verify.

-- 1) Ensure fraud rules table exists (function queries it at CREATE time).
...
-- 2) Re-create fraud RPC in public with the verified signature.
...
-- 3) Ensure grants and cache refresh for PostgREST.
